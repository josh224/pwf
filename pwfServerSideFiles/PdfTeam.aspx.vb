            ...
            Try
                ...
                For i As Integer = 1 To 5
                    Try
                        ...
                        workbook1 = New Workbook(dataDir & "teams.xlsx")
                        Exit For
                ...
                If Not String.IsNullOrEmpty(Request.Form("arraySize")) Then
                                        ...
                                        For j = 0 To 6
                                            ...
                                            Try
                                                If Not String.IsNullOrEmpty(riskValues(j)) Then
                                                    ...
                                                    range(rowcount, offsetColumnIndex).PutValue(riskValues(j))
                    ...
                    End Try
                    workbook1.Save(HttpContext.Current.Response, "ProjectTeams." & saveAs, ContentDisposition.Attachment, New XlsSaveOptions(saveFormat))
